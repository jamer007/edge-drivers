...
function PowerConfiguration.attr_id_map()
    return {
    [0x0000] = "MainsVoltage",
...
function PowerConfiguration.server_id_map()
    return {
  }
end

function PowerConfiguration.client_id_map()
    return {
  }
end
...
PowerConfiguration:init_attributes_table()
PowerConfiguration:init_commands_table()
