...
function ColorControl.attr_id_map()
    return {
    [0x0000] = "CurrentHue",
...
function ColorControl.server_id_map()
    return {
    [0x00] = "MoveToHue",
    [0x01] = "MoveHue",
    [0x02] = "StepHue",
...
function ColorControl.client_id_map()
    return {
  }
end
...
ColorControl:init_attributes_table()
ColorControl:init_commands_table()
