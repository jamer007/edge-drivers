...
function DeviceTempAlarmMask.pretty_print(value_obj)
  ...
  return string.format("%s: %s[0x%s]", value_obj.field_name or value_obj.NAME, DeviceTempAlarmMask.NAME, zb_utils.pretty_print_hex_str(string.pack(pattern, value_obj.value)))
end
