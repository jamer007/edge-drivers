...
--- @field public MeterIdentification st.zigbee.zcl.clusters.MeterIdentification
...
zcl_clusters.meter_identification_id                    = 0x0B01
...
zcl_clusters.id_to_name_map = {
    ...
    [zcl_clusters.meter_identification_id]                    = "MeterIdentification",
