...
--- @class st.zigbee.zcl.clusters.MeterIdentification.MeterTypeID
--- @alias MeterTypeID
---
--- @field public ID number 0x0001 the ID of this attribute
--- @field public NAME string "MeterTypeID" the name of this attribute
...
function MeterTypeID:augment_type(base_type_obj)
  cluster_base.attribute_augment_type_default(self, base_type_obj)
end

function MeterTypeID.pretty_print(value_obj)
  MeterTypeID.base_type.pretty_print(value_obj)
end

--- @function MeterTypeID:build_test_attr_report
---
...
MeterTypeID.build_test_attr_report = cluster_base.build_test_attr_report

--- @function MeterTypeID:build_test_read_attr_response
---
--- Build a Rx Zigbee message as if a device sent a read response for this attribute
--- @param device st.zigbee.Device
--- @param data st.zigbee.data_types.Uint16 the attribute value
--- @return st.zigbee.ZigbeeMessageRx containing an ReadAttributeResponse body
MeterTypeID.build_test_read_attr_response = cluster_base.build_test_read_attr_response

--- Create a Uint16 object of this attribute with any additional features provided for the attribute
---
--- This is also usable with the MeterTypeID(...) syntax
---
--- @vararg vararg the values needed to construct a Uint16
--- @return st.zigbee.data_types.Uint16
function MeterTypeID:new_value(...)
...
function MeterTypeID:read(device)
...
function MeterTypeID:configure_reporting(device, min_rep_int, max_rep_int, rep_change)
...
function MeterTypeID:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

setmetatable(MeterTypeID, {__call = MeterTypeID.new_value})
return MeterTypeID
