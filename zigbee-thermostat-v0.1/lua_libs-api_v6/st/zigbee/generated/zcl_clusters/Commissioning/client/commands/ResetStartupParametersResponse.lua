...
function ResetStartupParametersResponse.deserialize(buf)
  return cluster_base.command_deserialize(ResetStartupParametersResponse, buf)
end
...
function ResetStartupParametersResponse.build_test_rx(device, status)
  ...
  return cluster_base.command_build_test_rx(ResetStartupParametersResponse, device, args, "client")
end
