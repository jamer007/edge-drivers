...
function Commissioning.attr_id_map()
    return {
    [0x0000] = "ShortAddress",
...
function Commissioning.server_id_map()
    return {
    [0x00] = "RestartDevice",
...
function Commissioning.client_id_map()
    return {
...
Commissioning:init_attributes_table()
Commissioning:init_commands_table()
