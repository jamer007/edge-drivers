...
local FORM_IMPL_PROF_TAG_4 = {code = 0xA0, type = data_types.Uint32.ID}
local FORM_FULL_QUAL_TAG_6 = {code = 0xC0, type = data_types.Uint16.ID} -- This variant uses a 16-bit tag number
local FORM_FULL_QUAL_TAG_8 = {code = 0xE0, type = data_types.Uint32.ID} -- This variant uses a 32-bit tag number
...
function TLVParser.get_tag_encoding_length(tag_control)
  ...
  local tagControls = {
    -- "Anonymous Tag Form, 0 octets"
    [0] = 0,

    -- "Context-specific Tag Form, 1 octet"
    [1] = 1,

    -- "Common Profile Tag Form, 2 octets"
    [2] = 2,

    -- "Common Profile Tag Form, 4 octets"
    [3] = 4,

    -- "Implicit Profile Tag Form, 2 octets"
    [4] = 2,

    -- "Implicit Profile Tag Form, 4 octets"
    [5] = 4,

    -- "Fully-qualified Tag Form, 6 octets"
    [6] = 2,

    -- "Fully-qualified Tag Form, 8 octets"
    [7] = 4,
  }
...
--- @return table
function TLVParser.decode_tlv_primitive(buf, control_octet_element_type, include_control_octet)
...
TLVParser.FORM_IMPL_PROF_TAG_4 = FORM_IMPL_PROF_TAG_4
