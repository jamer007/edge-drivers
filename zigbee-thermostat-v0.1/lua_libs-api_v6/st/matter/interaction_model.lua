...
function InteractionInfoBlock.from_parts(cls, endpoint_id, cluster_id, attribute_id, event_id,
  ...
  local cluster = zap_clusters.get_cluster_from_id(info_block.cluster_id)
...
local _STATUS_STRINGS = {
  ...
  [_STATUS.NO_UPSTREAM_SUBSCRIPTION] = "NO_UPSTREAM_SUBSCRIPTION",
  ...
  [_STATUS.TIMED_REQUEST_MISMATCH] = "TIMED_REQUEST_MISMATCH",
  [_STATUS.FAILSAFE_REQUIRED] = "FAILSAFE_REQUIRED",
}
